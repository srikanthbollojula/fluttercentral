...
class _AnimatedListSampleState extends State<AnimatedListSample> {
  ...
  Widget _buildRemovedItem(
      Choice item, BuildContext context, Animation<double> animation) {
    return CardItem(
      animation: animation,
      item: item,
      selected: false,
          ...
          child: Row(
              children: <Widget>[
                new Container( 
                  ...
                  child: Icon(item.icon, size:80.0, color: textStyle.color,)),
                new Expanded( 
                  child: new Container( 
                  padding: const EdgeInsets.all(10.0),
                  alignment: Alignment.topLeft,
                  child:                    
                    Text(item.title, style: null, textAlign: TextAlign.left, maxLines: 5,),
                    )
                  ),
              ],
