            ...
            children: <Widget>[ 
              new DrawerHeader(
                ...
                new UserAccountsDrawerHeader(
                  accountName: new Text('Someusername', style: TextStyle(
                    color: Colors.black
                  ),), accountEmail: new Text('Someemail@flutter.com', style: TextStyle(
                    color: Colors.black
                  ),), 
              ...
              new ListTile(
                ...
                onTap: () {_opennewpage("page 1");}),
              new ListTile(
                leading: new Icon(Icons.info),
                title: new Text("Page 2"),
                onTap: () {_opennewpage("page 2");}),
              new ListTile(
                leading: new Icon(Icons.info),
                title: new Text("Page 3"),
                onTap: () {_opennewpage("page 3");}),              
              new ListTile(
